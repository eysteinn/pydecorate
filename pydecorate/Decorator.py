...
class Decorator(DecoratorBase):
    def add_scale(self,color_def,font=None,size=None,fill='black',
                  ...
                  nan_color=(0,0,0), nan_check_color=(1,1,1), nan_check_size=0,  minor_tick_marks=1, tick_marks=10,):
        """ Todo
        """
        self._add_scale(color_def,font=font,size=size,fill=fill,
                        ...
                        nan_color=nan_color, nan_check_color=nan_check_color, nan_check_size=nan_check_size, minor_tick_marks= minor_tick_marks,tick_marks=tick_marks)
